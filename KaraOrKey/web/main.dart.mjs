...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1351: x0 => x0.play(),
      _1352: x0 => x0.load(),
      _1353: (x0,x1) => x0.removeAttribute(x1),
      _1354: (x0,x1) => x0.setSinkId(x1),
      _1362: x0 => globalThis.Wakelock.toggle(x0),
      _1364: (x0,x1) => x0.getItem(x1),
      _1366: (x0,x1,x2) => x0.setItem(x1,x2),
      _1369: x0 => ({audio: x0}),
      _1370: (x0,x1) => x0.getUserMedia(x1),
      _1371: x0 => x0.getAudioTracks(),
      _1372: x0 => x0.stop(),
      _1373: x0 => ({video: x0}),
      _1374: x0 => x0.getVideoTracks(),
      ...
      _1378: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1381: Date.now,
      ...
      _1587: x0 => new WebSocket(x0),
      _1588: (x0,x1) => new WebSocket(x0,x1),
      _1589: (x0,x1) => x0.send(x1),
      _1590: x0 => x0.close(),
      _1591: (x0,x1) => x0.getResponseHeader(x1),
      _1592: x0 => x0.abort(),
      _1593: () => new AbortController(),
      _1594: x0 => x0.abort(),
      _1595: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1596: (x0,x1) => globalThis.fetch(x0,x1),
      _1597: (x0,x1) => x0.get(x1),
      _1598: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1598(f,arguments.length,x0,x1,x2) }),
      _1599: (x0,x1) => x0.forEach(x1),
      _1600: x0 => x0.getReader(),
      _1601: x0 => x0.cancel(),
      _1602: x0 => x0.read(),
      _1603: (x0,x1) => x0.appendChild(x1),
      _1604: (x0,x1) => x0.item(x1),
      ...
      _1709: x0 => x0.readyState,
      _1711: (x0,x1) => { x0.timeout = x1 },
      _1713: (x0,x1) => { x0.withCredentials = x1 },
      _1716: x0 => x0.status,
      _1719: (x0,x1) => { x0.responseType = x1 },
      _1721: x0 => x0.responseText,
      _2399: x0 => x0.error,
      _2400: x0 => x0.src,
      _2401: (x0,x1) => { x0.src = x1 },
      _2409: (x0,x1) => { x0.preload = x1 },
      _2410: x0 => x0.buffered,
      _2413: x0 => x0.currentTime,
      _2414: (x0,x1) => { x0.currentTime = x1 },
      _2415: x0 => x0.duration,
      _2420: (x0,x1) => { x0.playbackRate = x1 },
      _2433: (x0,x1) => { x0.volume = x1 },
      _2450: x0 => x0.code,
      _2451: x0 => x0.message,
      _2525: x0 => x0.length,
      _3028: x0 => x0.src,
      _3029: (x0,x1) => { x0.src = x1 },
      _3031: (x0,x1) => { x0.type = x1 },
      _3035: (x0,x1) => { x0.async = x1 },
      _3049: (x0,x1) => { x0.charset = x1 },
      _3498: () => globalThis.window,
      _3542: x0 => x0.location,
      _3561: x0 => x0.navigator,
      _3825: x0 => x0.localStorage,
      _3836: x0 => x0.protocol,
      _3840: x0 => x0.hostname,
      _3842: x0 => x0.port,
      _3931: x0 => x0.geolocation,
      _3934: x0 => x0.mediaDevices,
      _3936: x0 => x0.permissions,
      _4001: x0 => x0.data,
      _4158: x0 => x0.length,
      _4388: x0 => x0.binaryType,
      _4389: (x0,x1) => { x0.binaryType = x1 },
      _6101: x0 => x0.signal,
      _6113: x0 => x0.length,
      _6174: () => globalThis.document,
      _6258: x0 => x0.head,
      _6620: x0 => x0.children,
      _7939: x0 => x0.value,
      _7941: x0 => x0.done,
      _8643: x0 => x0.url,
      _8645: x0 => x0.status,
      _8647: x0 => x0.statusText,
      _8648: x0 => x0.headers,
      _8649: x0 => x0.body,
      _9437: x0 => x0.active,
      _12272: x0 => x0.name,
